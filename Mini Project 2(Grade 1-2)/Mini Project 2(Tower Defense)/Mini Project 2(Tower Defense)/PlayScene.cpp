...
const std::vector<int> PlayScene::code = { ALLEGRO_KEY_UP, ALLEGRO_KEY_UP, ALLEGRO_KEY_DOWN, ALLEGRO_KEY_DOWN,
									...
									ALLEGRO_KEY_B, ALLEGRO_KEY_A, ALLEGRO_KEYMOD_SHIFT, ALLEGRO_KEY_ENTER };  // cheat
...
void PlayScene::Update(float deltaTime) {
	...
	for (int i = 0; i < SpeedMult; i++) {
		...
		if (enemyWaveData.empty()) {
			if (EnemyGroup->GetObjects().empty()) {
				// Free resources.  //not need free here or it will crash(changescene will do it.)
                /*
				delete TileMapGroup;
                 ...
                 */
				// Win.
				Engine::GameEngine::GetInstance().ChangeScene("win"); // crash error_name of win scene.
			}
			continue;
		}
	...
	//         The format is "[EnemyId] [TimeDelay] [Repeat]".  finish.
...
void PlayScene::OnKeyDown(int keyCode) {
	...
	if (keyCode == ALLEGRO_KEY_TAB) {
        ...
        if (keyCode == ALLEGRO_KEY_ENTER && keyStrokes.size() == code.size()) {  // cheat
	...
	// TODO 2 (5/8): Make the R key to create the 4th turret. finish
...
void PlayScene::ConstructUI() {
    ...
    btn = new TurretButton("play/floor.png", "play/dirt.png",
        ...
        Engine::Sprite("play/turret-5.png", 1522, 136 - 8, 0, 0, 0, 0)
        , 1370, 136, NewTurret::Price);
...
void PlayScene::UIBtnClicked(int id) {
	...
	// TODO 2 (4/8): On callback, create the 4th tower.  finish.
	if (!preview)
		return;
	preview->Position = Engine::GameEngine::GetInstance().GetMousePosition();
